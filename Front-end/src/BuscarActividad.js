...
import Resultado from "./componentes/ResultadoAct";
...
class App extends Component {
  ...
  consultarApi = async () => {
    ...
    const res = await axios.get(
      `https://api-aventurate.herokuapp.com/services/${this.state.termino}`
    );
      ...
      <div style={style2} className="Actividad container">
        ...
        <div style={style} className="Informacion row justify-content-center ">
          <div className="btn-group" role="group" aria-label="Basic example">
            <Btncambio buttontext="Hoteles" link="/SearchHotel" />
            <Btncambio
