                ...
                <form className="row">
                    <div className="jumbotron-fluid Registerbody" align="center">
                        ...
                        <div className="row campos">
                            ...
                            <div className="col-6" align="center">
                                <label for="inp" className="inp">
                                    <input type="tel" id="Telefono" placeholder="&nbsp;" onChange={event => this.valueToState(event.target)} />
                        ...
                        <div className="row campos">
                            <div className="col-6" align="center">
                                <label for="inp" className="inp">
                                    <input type="email" id="Correo" placeholder="&nbsp;" onChange={event => this.valueToState(event.target)} />
                        ...
                        <div className="row campos">
                            <div className="input-group mb-3 col-6">
                                <label for="inp" className="inp">
                                    <input type="number" id="Identificacion" placeholder="&nbsp;" onChange={event => this.valueToState(event.target)} />
